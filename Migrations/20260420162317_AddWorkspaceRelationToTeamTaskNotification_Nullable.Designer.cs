...
namespace SyncVerse.Migrations
{
    ...
    [Migration("20260420162317_AddWorkspaceRelationToTeamTaskNotification_Nullable")]
    partial class AddWorkspaceRelationToTeamTaskNotification_Nullable
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SyncVerse.Domain.Entities.WorkspaceInvitation", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
                    ...
                    b.Property<string>("InvitedByManagerId")
                        .IsRequired()
                        .HasColumnType("nvarchar(450)");
                    ...
                    b.Property<string>("RoleToAssign")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("SyncVerse.Domain.Entities.WorkspaceInvitation", b =>
                {
                    b.HasOne("SyncVerse.Domain.Entities.User", "InvitedByManager")
                        .WithMany()
