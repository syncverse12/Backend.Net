...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Graduation_Project.Domain.Models.User", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityRoleClaim<string>", b =>
                {
                    b.HasOne("Graduation_Project.Domain.Models.Role", null)
                        .WithMany()
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("Graduation_Project.Domain.Models.User", null)
                        .WithMany()
            ...
            modelBuilder.Entity("Synverse.Domain.Entities.TaskEmployee", b =>
                {
                    b.HasOne("Graduation_Project.Domain.Models.User", "AssignedUser")
                        .WithMany()
            ...
            modelBuilder.Entity("Synverse.Domain.Entities.TimeLog", b =>
                {
                    ...
                    b.HasOne("Graduation_Project.Domain.Models.User", "User")
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Restrict);
            ...
            modelBuilder.Entity("TaskItem", b =>
                {
                    b.HasOne("Graduation_Project.Domain.Models.User", "AssignedToUser")
                        .WithMany()
                    ...
                    b.HasOne("Graduation_Project.Domain.Models.User", "ReviewedByUser")
                        .WithMany()
