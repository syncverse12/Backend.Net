...
namespace Graduation_Project.Migrations
{
    ...
    [Migration("20260216040359_AddTaskCommentsSystem")]
    partial class AddTaskCommentsSystem
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Synverse.Domain.Entities.TimeLog", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("Synverse.Domain.Entities.TimeLog", b =>
                {
                    b.HasOne("Synverse.Domain.Entities.TaskEmployee", "Task")
                        .WithMany("TimeLogs")
                        .HasForeignKey("TaskId");
