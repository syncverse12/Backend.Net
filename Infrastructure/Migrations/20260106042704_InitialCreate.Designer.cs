...
namespace SyncVerse.Migrations
{
    ...
    [Migration("20260106042704_InitialCreate")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SyncVerse.Models.Role", b =>
                {
            ...
            modelBuilder.Entity("SyncVerse.Models.User", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityRoleClaim<string>", b =>
                {
                    b.HasOne("SyncVerse.Models.Role", null)
                        .WithMany()
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("SyncVerse.Models.User", null)
                        .WithMany()
